...
@method('put')
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_Date"
                                       type="text" value="{{$invoice->invoice_data}}" required>
                                @error('invoice_date')
                                <small class="form-text text-muted" style="color:red !important">{{$message}}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="Due_date"
                                       type="text" required value="{{$invoice->due_data}}">
                                @error('due_date')
                                <small class="form-text text-muted" style="color:red !important">{{$message}}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="exampleTextarea" name="note" rows="3" value="{{$invoice->note}}" >
                            </div>
                        </div><br>
    ...
    <script>
        function myFunction() {
            ...
            if (typeof Amount_Commission === 'undefined' || !Amount_Commission) {
                ...
                var tax_value = Amount_Commission2 * Rate_VAT / 100;
                var total_value = parseFloat(tax_value + Amount_Commission2);
                sumq = parseFloat(tax_value).toFixed(2);
                sumt = parseFloat(total_value).toFixed(2);
