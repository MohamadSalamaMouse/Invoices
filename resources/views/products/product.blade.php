                ...
                <div class="card-header pb-0">
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="col-sm-6 col-md-4 col-xl-3 mg-t-20">
                            <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-super-scaled" data-toggle="modal" href="#modaldemo8">اضافة منتج</a>
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{route('product.destroy',$product->id)}}" method="post">
                                        ...
                                        <a class="btn btn-primary"  role="button" href="{{route('product.edit',$product->id)}}" data-inline="true">update</a>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content tx-size-sm">
                    <div class="modal-body tx-center pd-y-20 pd-x-20">
                        ...
                        <form class="{{route('product.store')}}" method="post">
                            @csrf
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">اسم المنتج</label>
                                <input type="text" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="اضافة منتج">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="exampleInputPassword1" name="Notes" placeholder="وصف المنتج">
                            </div>
